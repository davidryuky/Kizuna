...
import { Mail, Send, MapPin, Phone, ShieldCheck } from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 animate-in fade-in duration-700">
      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        <div className="space-y-6 md:space-y-8">
          <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-rose-50 flex items-center gap-6 group hover:shadow-md transition-all">
            ...
            <div>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1">E-mail Corporativo</p>
          ...
          <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-rose-50 flex items-center gap-6 group hover:shadow-md transition-all">
            ...
            <div>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1">Atendimento Direto</p>
              <p className="text-lg font-bold text-gray-900">+55 (11) 97721-0044</p>
            </div>
          </div>

          <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 flex flex-col gap-4">
            <div className="flex items-center gap-3 text-rose-500 mb-2">
              <ShieldCheck size={24} />
              <span className="font-bold uppercase text-xs tracking-widest">Suporte Dedicado</span>
            </div>
            <p className="text-sm text-gray-500 leading-relaxed font-medium">
              Nossa equipe está pronta para auxiliar você na eternização da sua história. Respondemos todas as solicitações em até 24 horas úteis.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-8 md:p-12 rounded-[3.5rem] shadow-2xl shadow-rose-50 border border-gray-50 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-rose-50 rounded-full blur-3xl opacity-40 -mr-16 -mt-16"></div>
          ...
          {sent ? (
            <div className="text-center py-12 md:py-20 animate-in fade-in zoom-in">
              ...
              <h3 className="text-3xl font-elegant font-bold mb-4 text-gray-900">Recebemos sua mensagem</h3>
              <p className="text-gray-400 font-medium">Retornaremos o contato em breve através do seu e-mail.</p>
              <button 
                onClick={() => setSent(false)} 
                className="mt-10 text-rose-500 font-black uppercase text-xs tracking-widest hover:underline"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
              <div className="space-y-3">
                <label className="text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] pl-1">{t.nameLabel}</label>
                <input 
                  required 
                  type="text" 
              ...
              <div className="space-y-3">
                <label className="text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] pl-1">{t.emailLabel}</label>
                <input 
                  required 
                  type="email" 
                  className="w-full px-6 py-4 rounded-2xl border-2 border-gray-50 bg-gray-50/50 focus:bg-white focus:border-rose-400 focus:ring-4 focus:ring-rose-50 outline-none transition-all font-medium text-gray-800" 
              ...
              <div className="space-y-3">
                <label className="text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] pl-1">{t.msgLabel}</label>
                <textarea 
                  required 
                  rows={4} 
